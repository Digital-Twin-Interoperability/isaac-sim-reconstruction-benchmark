...
def build_system_prompt(*, render_enabled: bool) -> str:
    ...
    lines = [
        ...
        "   `fixed --[attach]--> new`.  Example for a U-curve:",
        "     - place the curve first with `add_component` at world origin;",
        "     - then `add_aligned_component(name='left_straight',",
        "       asset_id=...A05, fixed_component='curve', fixed_anchor='in',",
        "       moving_anchor='out')`.",
